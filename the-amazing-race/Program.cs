    ...
    class Program
    {
        private static void Main(string[] args)
        {
            ...
            if (args.Length == 0)
            {
                ...
                /*
                 * By default, Git ignores *.user files generated by Visual Studio.
                 * There are probably great reasons for that, so that remains deliberately unchanged.
                 * 
                 * But if you're reading this, then you have access to the source. And
                 * with that being the case, it would be much more convenient to specify command line
                 * arguments from the Startup section of the Debug tab of the Project Properties page.
                 */
            }
            else
            {
